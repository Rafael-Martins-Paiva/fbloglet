...
export default function Component() {
  ...
  return (
    <header className="sticky top-0 z-20 w-full border-b border-border/40 px-4 md:px-6 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
